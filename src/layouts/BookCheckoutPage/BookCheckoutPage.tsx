...
export const BookCheckoutPage = () => {
  ...
  useEffect(() => {
    const fetchBook = async () => {
      ...
      const baseUrl: string = `${process.env.REACT_APP_API}/books/search/findBookByIdWithProjection?id=${bookId}`;
  ...
  useEffect(() => {
    const fetchUserCurrentLoansCount = async () => {
      if (authState && authState.isAuthenticated) {
        ...
        console.log("bu response count ", currentLoansCountResponse);
  ...
  useEffect(() => {
    const fetchUserCheckedOutBook = async () => {
      if (authState && authState.isAuthenticated) {
        ...
        console.log("response checkedOut ", bookCheckedOut);
  ...
  // console.log("isLoadingCurrentLoansCount = " + isLoadingCurrentLoansCount);
  // console.log("isLoadingBookCheckedOut = " + isLoadingBookCheckedOut);
  // console.log("isLoadingUserReview = " + isLoadingUserReview);
  ...
  async function submitReview(rating: number, reviewDescription: string) {
    ...
    if (book?.id) {
      bookId = book.id;
      console.log("en son gönderilen book id" + bookId);
    }
    ...
    console.log("review Request Model", reviewRequestModel);
